...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
     ...
     * @param \Mageplaza\HelloWorld\Model\Source\Approved $approved
     * @param array $data
     */
    public function __construct(
        ...
        \Mageplaza\HelloWorld\Model\Source\Approved $approved,
        array $data = []
    )
    {
    ...
    protected function _prepareForm()
    {
        ...
        $form->setHtmlIdPrefix('mageplaza_helloworld_');
        if ($model) {
